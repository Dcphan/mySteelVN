...
from backend.ETL_pipeline import parser, regex_pattern, country_detection, country_dictionary, hs_and_currency, hs_code, unit, unit_conversion, import_pipeline
...
class XNK_pipeline:
    ...
    def save_to_database(self, importer_i_df, product_id_df, transaction_df):
        self.db_manager.add_to_database(importer_i_df, product_id_df, transaction_df)
    ...
    def import_function(self):
        ...
        self.save_to_database(importer_i_df, product_id_df, transaction_df)
