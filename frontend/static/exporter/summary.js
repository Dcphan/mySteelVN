    ...
    const url = new URL('https://mysteelvn.onrender.com/api/exporter-filtering-data'); 
   ...
   function toggleCompanies(value) {
    ...
    export async function fetchAndRenderTable(filter_fields, rows_fields, values_fields) {
      ...
      const url = new URL("https://mysteelvn.onrender.com/api/exporter-pivot-data");
      ...
      fetchTableWithTwoRows(filter_fields, rows_fields, values_fields, data);
        ...
        const url = new URL("https://mysteelvn.onrender.com/api/exporter-single-pivot-summary");
